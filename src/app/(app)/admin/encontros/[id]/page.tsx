      ...
      <section>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
            ...
            <ul className="mb-4 flex flex-col gap-2">
              {preparations.map((p) => {
                ...
                return (
                  <li
                    key={p.id}
                    className="flex items-center justify-between rounded-md bg-slate-50 px-3 py-2 text-sm dark:bg-slate-900 dark:text-slate-300"
                  >
          ...
          <form action={addPreparationWithId} className="flex gap-2">
            ...
            <button
              type="submit"
              className="rounded-md bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-700 dark:bg-slate-700 dark:hover:bg-slate-600"
            >
              Adicionar
            </button>
          </form>
