  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section>
        ...
        {meetings.length === 0 ? (
          <p className="text-sm text-slate-500">Nenhum encontro ainda.</p>
        ) : (
            ...
            {meetings.map((m) => (
              <li key={m.id}>
                <Link
                  ...
                  className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm hover:border-indigo-300"
                >
